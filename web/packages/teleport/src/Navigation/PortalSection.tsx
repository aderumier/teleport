  ...
  return [
    {
      ...
      searchableTags: ['portal', 'resources', 'all resources'],
      category: NavigationCategory.Portal,
      exact: false,
    ...
    },
    {
      ...
      searchableTags: ['portal', 'resources', 'pinned resources'],
      category: NavigationCategory.Portal,
      exact: false,
      customRouteMatchFn: currentViewRoute =>
        !!matchPath(currentViewRoute, {
    ...
    },
    {
      ...
      searchableTags: ['portal', 'apps', 'applications'],
      category: NavigationCategory.Portal,
      exact: false,
    ...
    },
    {
      ...
      searchableTags: ['portal', 'dbs', 'databases'],
      category: NavigationCategory.Portal,
      exact: false,
    ...
    },
    {
      ...
      searchableTags: ['portal', 'desktops', 'rdp', 'windows'],
      category: NavigationCategory.Portal,
      exact: false,
    ...
    },
    {
      ...
      icon: Icons.GitHub,
      route: gitOnlyRoute,
      searchableTags: ['portal', 'git', 'github', 'git servers'],
      category: NavigationCategory.Portal,
      exact: false,
    ...
    },
    {
      ...
      searchableTags: ['portal', 'k8s', 'kubes', 'kubernetes'],
      category: NavigationCategory.Portal,
      exact: false,
    ...
    },
    {
      ...
      route: mcpOnlyRoute,
      searchableTags: ['portal', 'mcp', 'mcp servers'],
      category: NavigationCategory.Portal,
      exact: false,
    ...
    },
    {
      ...
      searchableTags: ['portal', 'servers', 'nodes', 'ssh resources'],
      category: NavigationCategory.Portal,
      exact: false,
...
export function PortalSection({
  ...
  const isExpanded = expandedSection?.category === NavigationCategory.Portal;

  const subsections = getPortalSubsections({
    clusterId,
    preferences,
    updatePreferences,
    searchParams,
